...
<head>
	...
	<title>Presentaciones Panel de Adminisrador</title>
...
<body>
	...
	<div class="panel-body">
	<a class="btn btn-primary" href="insertarPresentacion.php" role="button">Ingresar nueva presentacion</a>
		...
		<table class="table table-hover">
			...
			$o=new Usuarios;
			$art = $o->selpresentacion();
			while ($a = mysql_fetch_array($art))
			{
				$idCat=$a['id_tipo_presentacion'];
				//$nombre_producto=$a['nombre_producto'];*/
			?>
				<tr>

					<td><?php echo $a['nombre'] ?></td>
					<td><a href="modiProducto.php?ID=<?php echo $idCat;?>">Modificar</a><a href="elimProducto.php?ID=<?php echo $idCat;?>">Eiminar producto</a></td>
				</tr>
			<?php
			}
			?>
