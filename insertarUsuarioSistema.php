...
if(isset($_POST['nuser']))//Codigo para envio de datos al servidor
{
  ...
  $d['0']=$_POST["nombUsuSist"];
  $d['1']=$_POST['apellPaterno'];
  $d['2']=$_POST['apellMaterno'];
  $d['3']=$_POST['usuarioSist'];
  $d['4']=$_POST['contrasena'];
  $d['5']=$_POST['tipoUsr'];

  //Creacion de objeto que <permita></permita> hacer la insercion de usuarios
  $objin=new Usuarios;
  $ins=$objin->insertUsuarioSistema($d);
  echo '<script languaje=javascript>';
  echo "alert('El producto ".$d['0']." fue agregado correctamente');";
  echo 'window.location="/Super_alan/verUsuariosSist.php";';
  echo '</script>';
  ...
  <div class="side-menu">
    <nav class="navbar navbar-default" role="navigation">
      ...
      <div class="side-menu-container">
        ...
        <form class="form-horizontal" action="insertarUsuarioSistema.php" name="valida_datos" method="post" enctype="multipart/form-data">
        <div class="col-md-10 content">
          <div class="panel panel-default">
            <div class="panel-heading">Panel de Administracion - <b>Ingreso de nuevo usuario del sistema.</b>
            </div>

          <div class="panel-body">
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="form-group">
                <label class="col-md-12" for="nombUsuSist">Nombre del personal</label>  
                <div class="col-md-12">
                  <input id="nombUsuSist" name="nombUsuSist" type="text" placeholder="ingresa su nombre" class="form-control input-md">
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input id="apellPaterno" name="apellPaterno" type="text" placeholder="ingresa el apellido paterno" class="form-control input-md">
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input id="apellMaterno" name="apellMaterno" type="text" placeholder="Ingresa el apellido materno" class="form-control input-md">
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input id="usuarioSist" name="usuarioSist" type="text" placeholder="Ingresa el nombre de usuario" class="form-control input-md">
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input id="contrasena" name="contrasena" type="password" placeholder="Ingresa una contraseña" class="form-control input-md">
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="form-group">
                <label for="input" class="col-md-5 control-label">Tipo de usuario</label>
                  <div class="col-md-12">
                    <select name="tipoUsr" id="tipoUsr"  class="form-control" required="required">
                      <?php // Consultar la base de datos
                        $objcat=new Usuarios();
                        $cat=$objcat->selTipUsua();
                        echo "<option selected='selected' disabled='disabled'>Eliga el privilegio de usuario</option>'";
                        while($tipoUser=mysql_fetch_array($cat))
                        {
                            echo "<option value='".$tipoUser['id_tipo_usuario']."'>".$tipoUser['nombre']."</option>";
                        }
                        echo "</select>";
                      ?>
                      </select>
