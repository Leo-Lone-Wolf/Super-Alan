...
<body>
	...
	<div class="panel-body">
	<a class="btn btn-primary" href="insertarArticulo.php" role="button">Insertar nuevo producto</a>
		...
		<table class="table table-hover">
			...
			{
				$idArt=$a['id_producto'];
				$idPres=$a['tipo_presentacion'];
				$idCat=$a['categoria_producto'];
				$idMarca=$a['marca'];

				$pre=new Usuarios;
				$pres = $pre->verPresent($idPres);
				$present=mysql_fetch_array($pres);
			...
			?>
				<tr>
					...
					<td><a href="modifProducto.php?ID=<?php echo $idArt;?>">Modificar</a>&nbsp<a href="elimProducto.php?ID=<?php echo $idArt;?>">Eiminar producto</a></td>
