...
{
  $idCliente=$idUsuario=$_SESSION['id_usuario'];
  ...
  $objin=new Usuarios;
  $ins=$objin->modifPerfil($iuser,$idCliente);
  echo '<script languaje=javascript>';
  echo "alert('El usuario ".$idCliente." fue modificado');";
...
$objseU=new Usuarios;
$selU = $objseU->editPerCliente($idCliente);
  ...
  <br>
    ...
    <nav class="navbar navbar-default" role="navigation"><!--Inicio de la barra de menu-->
      <div class="container-fluid">
        ...
        <form class="form-horizontal" action="perfilCliente.php" name="valida_datos" method="post">


          <fieldset>
          <!-- Form Name -->
            <legend>Modifique los campos que requiera</legend>
          ...
          <div class="form-group">
            <label class="col-md-12" for="nombre">Nombre</label>  
              <div class="col-md-12">
                <input id="nombre" name="nombre" type="text" placeholder="" value="<?php echo $seleU['nombre'];?>" class="form-control input-md">
              </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="form-group">
            <label class="col-md-12" for="apellidos">Apellidos</label>  
              <div class="col-md-12">
                <input id="apellidos" name="apellidos" type="text" placeholder="" value="<?php echo $seleU['apellidos'];?>" class="form-control input-md">
              </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="form-group">
            <label class="col-md-12" for="usuario">Nombre de usuario</label>  
              <div class="col-md-12">
                <input id="usuario" name="usuario" type="text" placeholder="" value="<?php echo $seleU['usuario'];?>" class="form-control input-md">
              </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="form-group">
            <label class="col-md-12" for="fecha_nacimiento">Fecha de nacimiento</label>  
              <div class="col-md-12">
                <input id="fecha_nacimiento" name="fecha_nacimiento" type="date" value="<?php echo $seleU['fecha_nacimiento'];?>" class="form-control input-md">
              </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="form-group">
            <label class="col-md-12" for="contrasena">Contraseña</label>  
              <div class="col-md-12">
                <input id="contrasena" name="contrasena" type="password" placeholder="" value="<?php echo $seleU['contrasena'];?>" placeholder="Ingresa tu contraseña" class="form-control input-md">
              </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="form-group">
            <label class="col-md-12" for="contrasena2">Confirma tu contraseña</label>  
              <div class="col-md-12">
                <input id="contrasena2" name="contrasena2" type="password" placeholder="" value="<?php echo $seleU['contrasena'];?>" class="form-control input-md">
              </div>
          </div>
        </div>
<br>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="form-group">
            <label class="col-md-12" for="nombreCalle">Calle</label>  
              <div class="col-md-12">
                <input id="nombreCalle" name="nombreCalle" type="text" placeholder="" value="<?php echo $seleU['nombre_calle'];?>" class="form-control input-md">
              </div>
          </div>
        </div>
        ...
        <br>
          <div class="form-group">
            <label class="col-md-3" for="numExt">Numero Exterior</label>  
              <div class="col-md-3">
                <input id="numExt" name="numExt" type="number" placeholder="" value="<?php echo $seleU['numero_exterior'];?>" class="form-control input-md">
              </div>
            <label class="col-md-2" for="numInt">Numero Interior</label>  
              <div class="col-md-3">
                <input id="numInt" name="numInt" type="number" placeholder="" value="<?php echo $seleU['numero_interior'];?>" class="form-control input-md">
              </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="form-group">
            <label class="col-md-12" for="entreCalle1">Entre Calle</label>  
              <div class="col-md-12">
                <input id="entreCalle1" name="entreCalle1" type="text" placeholder="" value="<?php echo $seleU['entre_calle1'];?>" class="form-control input-md">
              </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="form-group">
            <label class="col-md-12" for="entreCalle2">Y Calle</label>  
              <div class="col-md-12">
                <input id="entreCalle2" name="entreCalle2" type="text" placeholder="" value="<?php echo $seleU['entre_calle2'];?>" class="form-control input-md">
              </div>
          </div>
        </div>
          ...
          <div class="form-group">
            <label class="col-md-12" for="apellidos">Descripcion de la vivienda</label>  
              <div class="col-md-12">
                ...
                <input name="descripcionVivienda" id="descripcionVivienda" class="form-control" rows="3" placeholder="" value="<?php echo $seleU['descripcion_vivienda'];?>" required="required"></input>
              </div>
          </div>
        </div>
        </div>
