...
if(isset($_POST['nuser']))//Codigo para envio de datos al servidor
{
  ...
  $objin=new Usuarios;
  $ins=$objin->insertMar($d);
  echo '<script languaje=javascript>';
  echo "alert('La marca ".$d['0']." fue agregada correctamente');";
  echo 'window.location="/Super_alan/verMarcas.php";';
  echo '</script>';
  ...
  <div class="side-menu">
    <nav class="navbar navbar-default" role="navigation">
      ...
      <div class="side-menu-container">
        ...
        <form class="form-horizontal" action="insertarMarca.php" name="valida_datos" method="post" enctype="multipart/form-data">
        <div class="col-md-10 content">
          <div class="panel panel-default">
            <div class="panel-heading">Panel de Administracion - <b>Ingreso de nueva marca.</b>
            </div>

          <div class="panel-body">
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="form-group">
                <label class="col-md-12" for="nombreMarca">Nombre de la marca</label>  
                <div class="col-md-12">
                  <input id="nombreMarca" name="nombreMarca" type="text" placeholder="Ingresa el nombre de la marca" class="form-control input-md">
                </div>
              </div>
            </div>
    ...
    <br>      
          <input type="hidden" name="nuser" value="post"/>
            <button type="button" class="btn btn-success col-lg-12" name="button" id="enviar_validar" value="Enviar">Ingresar marca</button>
      </div>
          </div>
        </div>
      </div>
