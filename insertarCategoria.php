...
if(isset($_POST['nuser']))//Codigo para envio de datos al servidor
{
  ...
  $objin=new Usuarios;
  $ins=$objin->insertCat($d);
  echo '<script languaje=javascript>';
  echo "alert('La categoria ".$d['0']." fue agregada correctamente');";
  echo 'window.location="/Super_alan/verCategorias.php";';
  echo '</script>';
  ...
  <div class="side-menu">
    <nav class="navbar navbar-default" role="navigation">
      ...
      <div class="side-menu-container">
        ...
        <form class="form-horizontal" action="insertarCategoria.php" name="valida_datos" method="post" enctype="multipart/form-data">
        <div class="col-md-10 content">
          <div class="panel panel-default">
            <div class="panel-heading">Panel de Administracion - <b>Ingreso de nueva categoria.</b>
            </div>

          <div class="panel-body">
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="form-group">
                <label class="col-md-12" for="nombreCat">Nombre de la categoria</label>  
                <div class="col-md-12">
                  <input id="nombreCat" name="nombreCat" type="text" placeholder="Ingresa el nombre del producto" class="form-control input-md">
                </div>
              </div>
            </div>
    ...
    <br>      
          <input type="hidden" name="nuser" value="post"/>
            <button type="button" class="btn btn-success col-lg-12" name="button" id="enviar_validar" value="Enviar">Ingresar categoria</button>
      </div>
          </div>
        </div>
      </div>
