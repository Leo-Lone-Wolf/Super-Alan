...
<head>
	...
	<title>Clientes Panel de Adminisrador</title>
...
<body>
	...
	<div class="panel-heading">
		<b>Usuarios del sistema de Super Alán</b>
	</div>
	<div class="panel-body">
	<a class="btn btn-primary" href="insertarUsuarioSistema.php" role="button">Registar Nuevo Usuario</a>
		...
		<table class="table table-hover">
			...
			{
				$iduUsuarioSis=$a['id_usuario_personal'];
				//$nombre_producto=$a['nombre_producto'];*/
			?>
				<tr>

					<td><?php echo $a['nombre'] ?></td>
					<td><?php echo $a['apellido_paterno']?>&nbsp<?php echo $a['apellido_materno'] ?></td>
					<td><a href="modiProducto.php?ID=<?php echo $idCliente;?>">Modificar</a>&nbsp<a href="elimProducto.php?ID=<?php echo $idCliente;?>">Eiminar usuario</a></td>
				</tr>
			<?php
			}
			?>
